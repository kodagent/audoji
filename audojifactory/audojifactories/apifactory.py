...
class AudioProcessor:
    def __init__(self, audio_file_instance, group_name=None):
        ...
        self.audio_path = "https://audojistore.s3.amazonaws.com/media/audio_files/Sam-Smith-Man-I-Am_iSrFxoN.mp3"
    ...
    async def process_and_save_segments(self, transcript, audio_file_instance):
        ...
        for i, segment in enumerate(transcript.segments):
            ...
            print("This is the segment data: ")
            print(segment_data)
    ...
    async def run_and_save_segments(self):
        ...
        print("This is the transcription result: ")
